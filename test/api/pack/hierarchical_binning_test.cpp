...
TEST(hierarchical_binning_test, another_example)
{
    ...
    EXPECT_EQ(header_buffer.str() + output_buffer.str(), expected_file) << header_buffer.str() << output_buffer.str();
}
...
TEST(hierarchical_binning_test, four_level_hibf)
{
    ...
    std::string expected_file
    {
        "#MERGED_BIN_0;0;0;0 max_bin_id:0\n"
        "#MERGED_BIN_0;0;0 max_bin_id:1\n"
        "#MERGED_BIN_0;0 max_bin_id:1\n"
        "#MERGED_BIN_0 max_bin_id:1\n"
        "#FILES\tBIN_INDICES\tNUMBER_OF_BINS\n"
        "seq4\t0;0;0;0;0\t1;1;1;1;32\n"
        "seq5\t0;0;0;0;32\t1;1;1;1;32\n"
...
TEST(hierarchical_binning_test, tb0_is_a_merged_bin_with_debug)
{
    ...
    std::string expected_file
    {
        ...
        "seq2\t0;0\t1;32\t1000;16\t1000;15\t1.00;1.00\t2;64\n"
        "seq3\t0;32\t1;32\t1000;16\t1000;15\t1.00;1.00\t2;64\n"
        "seq0\t1;0\t1;32\t1000;16\t1000;15\t1.00;1.00\t2;64\n"
        "seq1\t1;32\t1;32\t1000;16\t1000;15\t1.00;1.00\t2;64\n"
    };
