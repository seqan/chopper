...
TEST(chopper_pack_test, many_ubs_debug)
{
    ...
    std::string const expected_file
    {
        ...
        "#MERGED_BIN_0 max_bin_id:9\n"
        "#MERGED_BIN_1 max_bin_id:9\n"
        "#MERGED_BIN_2 max_bin_id:9\n"
        "#MERGED_BIN_3 max_bin_id:13\n"
        "#MERGED_BIN_4 max_bin_id:9\n"
        "#MERGED_BIN_5 max_bin_id:9\n"
        "#MERGED_BIN_6 max_bin_id:9\n"
        "#MERGED_BIN_7 max_bin_id:9\n"
        "#MERGED_BIN_8 max_bin_id:9\n"
        "#MERGED_BIN_9 max_bin_id:9\n"
        "#MERGED_BIN_28 max_bin_id:0\n"
        "#MERGED_BIN_63 max_bin_id:0\n"
        "#FILES\tBIN_INDICES\tNUMBER_OF_BINS\tEST_MAX_TB_SIZES\tSCORE\tCORR\tT_MAX\n"
        "seq15\t0;0\t1;9\t600;12\t600;26\t1.00;3.70\t64;64\n"
        "seq16\t0;9\t1;4\t600;25\t600;26\t1.00;2.23\t64;64\n"
        "seq17\t0;13\t1;4\t600;25\t600;26\t1.00;2.23\t64;64\n"
        "seq18\t0;17\t1;4\t600;25\t600;26\t1.00;2.23\t64;64\n"
        "seq19\t0;21\t1;4\t600;25\t600;26\t1.00;2.23\t64;64\n"
        "seq0\t0;25\t1;39\t600;3\t600;26\t1.00;10.50\t64;64\n"
        "seq9\t1;0\t1;9\t600;12\t600;26\t1.00;3.70\t64;64\n"
        "seq10\t1;9\t1;4\t600;25\t600;26\t1.00;2.23\t64;64\n"
        "seq11\t1;13\t1;4\t600;25\t600;26\t1.00;2.23\t64;64\n"
        "seq12\t1;17\t1;4\t600;25\t600;26\t1.00;2.23\t64;64\n"
        "seq13\t1;21\t1;4\t600;25\t600;26\t1.00;2.23\t64;64\n"
        "seq14\t1;25\t1;39\t600;3\t600;26\t1.00;10.50\t64;64\n"
        "seq3\t2;0\t1;9\t600;12\t600;26\t1.00;3.70\t64;64\n"
        "seq4\t2;9\t1;4\t600;25\t600;26\t1.00;2.23\t64;64\n"
        "seq5\t2;13\t1;4\t600;25\t600;26\t1.00;2.23\t64;64\n"
        "seq6\t2;17\t1;4\t600;25\t600;26\t1.00;2.23\t64;64\n"
        "seq7\t2;21\t1;4\t600;25\t600;26\t1.00;2.23\t64;64\n"
        "seq8\t2;25\t1;39\t600;3\t600;26\t1.00;10.50\t64;64\n"
        "seq33\t3;0\t1;13\t600;16\t600;26\t1.00;4.73\t64;64\n"
        "seq32\t3;13\t1;8\t600;25\t600;26\t1.00;3.43\t64;64\n"
        "seq1\t3;21\t1;4\t600;25\t600;26\t1.00;2.23\t64;64\n"
        "seq2\t3;25\t1;39\t600;3\t600;26\t1.00;10.50\t64;64\n"
        "seq30\t4;0\t1;9\t600;23\t600;50\t1.00;3.70\t64;64\n"
        "seq35\t4;9\t1;4\t600;50\t600;50\t1.00;2.23\t64;64\n"
        "seq34\t4;13\t1;51\t600;4\t600;50\t1.00;13.00\t64;64\n"
        "seq38\t5;0\t1;9\t600;23\t600;50\t1.00;3.70\t64;64\n"
        "seq37\t5;9\t1;4\t600;50\t600;50\t1.00;2.23\t64;64\n"
        "seq36\t5;13\t1;51\t600;4\t600;50\t1.00;13.00\t64;64\n"
        "seq20\t6;0\t1;9\t600;23\t600;50\t1.00;3.70\t64;64\n"
        "seq31\t6;9\t1;4\t600;50\t600;50\t1.00;2.23\t64;64\n"
        "seq39\t6;13\t1;51\t600;4\t600;50\t1.00;13.00\t64;64\n"
        "seq23\t7;0\t1;9\t600;23\t600;50\t1.00;3.70\t64;64\n"
        "seq22\t7;9\t1;4\t600;50\t600;50\t1.00;2.23\t64;64\n"
        "seq21\t7;13\t1;51\t600;4\t600;50\t1.00;13.00\t64;64\n"
        "seq27\t8;0\t1;9\t600;23\t600;50\t1.00;3.70\t64;64\n"
        "seq26\t8;9\t1;4\t600;50\t600;50\t1.00;2.23\t64;64\n"
        "seq25\t8;13\t1;51\t600;4\t600;50\t1.00;13.00\t64;64\n"
        "seq29\t9;0\t1;9\t600;23\t600;50\t1.00;3.70\t64;64\n"
        "seq24\t9;9\t1;4\t600;50\t600;50\t1.00;2.23\t64;64\n"
        "seq28\t9;13\t1;51\t600;4\t600;50\t1.00;13.00\t64;64\n"
        ...
        "seq49\t28;0\t1;7\t600;43\t600;74\t1.00;3.15\t64;64\n"
        "seq50\t28;7\t1;57\t600;6\t600;74\t1.00;14.24\t64;64\n"
        ...
        "seq95\t63;0\t1;7\t1000;72\t600;124\t1.00;3.15\t64;64\n"
        "seq80\t63;7\t1;57\t1000;9\t600;124\t1.00;14.24\t64;64\n"
    };
    std::string const actual_file{string_from_file(pack_file.get_path())};
